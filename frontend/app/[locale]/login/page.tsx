...
// Hardcoded for dev (should be env vars)
            ...
            <Tabs defaultValue="login" className="w-full">
                ...
                <TabsContent value="login">
                     <form onSubmit={handleLogin} className="space-y-4">
                        ...
                        {error && (
                            <div className="text-sm text-red-500 bg-red-50 dark:bg-red-900/20 p-3 rounded-md border border-red-200 dark:border-red-900">
                                {error}
                            </div>
                        )}
                ...
                <TabsContent value="register">
                    <form onSubmit={handleSignUp} className="space-y-4">
                        ...
                        <div className="space-y-2">
                         ...
                         {error && (
                            <div className={`text-sm p-3 rounded-md border ${error.includes("Check") ? "text-green-600 bg-green-50 border-green-200" : "text-red-500 bg-red-50 border-red-200"}`}>
                                {error}
                            </div>
                        )}
                         <Button type="submit" className="w-full" disabled={loading}>
