  ...
  const handleTabChange = async (value: string) => {
    if (value === "quiz" && !quizData && !loadingQuiz) {
        ...
        try {
            ...
            // We don't alert here to avoid spamming if user switches fast, the UI shows error state
        } finally {
            ...
            <Tabs defaultValue="analysis" className="w-full" onValueChange={handleTabChange}>
                ...
                <TabsContent value="quiz" className="mt-0">
                    {loadingQuiz ? (
                        ...
                        <QuizView questions={quizData} onReset={() => setQuizData(null)} />
                    ) : (
                ...
                <TabsContent value="flashcards" className="mt-0">
                    {loadingFlashcards ? (
                        <div className="flex flex-col items-center justify-center py-12 space-y-4">
                         ...
                         <FlashcardView cards={flashcardsData} onReset={() => setFlashcardsData(null)} />
                    ) : (
                        <div className="text-center py-12 text-muted-foreground">
                            {t('flashcards_error')}
